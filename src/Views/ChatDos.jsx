    ...
    return (
        <Fragment>
            <div className='chat-header'>
                <Link to="/main" > <img className='chat-arrow' src={back} alt='Go Back' /></Link>
                <p className="chat-title" >ATENCIÓN AL CLIENTE TENPO</p>
            </div>

            <div className='chat-container'>
                <ChatDialogue value='Hola CAMILA, encantados de comunicarnos contigo' />
                ...
                <div className='chat-options'>
...

                    {
                        activeButton ? (
                            <Fragment>
                                <ChatDialogue value='Lo sentimos CAMILA ¿De qué se trata el problema? Selecciona una opción para poder ayudarte ' />
                            ...
                            <Fragment>
                                ...
                                <div className="solution-results" >
                                    ...
                                    <div className="solution-icons" >
                                        ...
                                        <Link to='/main' ><button className="icon-button"><img src={rightIcon} alt="si me ayudaron a solucionar mi problema" /></button></Link>
                                    </div>
                        ...
                        wrong ? (
                            <Fragment>
                                ...
                                <div className="backtostart-container" >
                                    <Link to='/main' ><button className="backtostart" >Volver al inicio</button></Link>
                                </div>
                            </Fragment>
                        ) : null
                    }
